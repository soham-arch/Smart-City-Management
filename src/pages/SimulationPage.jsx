...
const SimulationPage = () => {
  ...
  const speedMs = speed === 'slow' ? 1500 : speed === 'fast' ? 300 : 600;
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex gap-4 mb-6 flex-wrap">
          ...
          <NeonButton onClick={handleFullSimulation} variant="blue" loading={fullSimRunning} disabled={fullSimRunning}>
            🏙️ Simulate Full City Emergency
          </NeonButton>
          <div className="flex items-center gap-2 ml-auto">
            <span className="text-[10px] font-mono text-[rgba(255,255,255,0.5)]">Speed:</span>
            {['slow', 'normal', 'fast'].map(s => (
              <button key={s} onClick={() => setSpeed(s)}
                className={`px-2 py-1 rounded text-xs font-mono transition-all ${
                  speed === s ? 'bg-[#39ff8f]/20 text-[#39ff8f] border border-[#39ff8f]/30' : 'text-[rgba(255,255,255,0.4)] border border-[#1a1a2e] hover:border-[#39ff8f]/20'
                }`}>
