...
const NodeMap = ({
  ...
  const handleWheel = useCallback((e) => {
    ...
    setViewBox(prev => {
      const newW = Math.max(300, Math.min(1200, prev.w * zoomFactor));
      const newH = Math.max(200, Math.min(800, prev.h * zoomFactor));
          ...
          return (
            <g key={idx}>
              ...
              <text
                ...
                y={midY - 6}
                textAnchor="middle"
                fill={active ? colors.accent : 'rgba(255,255,255,0.25)'}
                fontSize="8"
            ...
            >
              ...
              {node.type !== 'junction' && (
                <text
                  ...
                  textAnchor="middle"
                  fill={isInPath || isOrigin || isDestination ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.4)'}
                  fontSize="8"
                  fontFamily="'JetBrains Mono', monospace"
                  className="pointer-events-none"
                >
